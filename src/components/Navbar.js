     ...
     <div>
       <div className="tab-menu-container show-xs">
        <div className="tab-menu">
          <div className="client-name">Fleming County Water Association</div>
          <div className="btn-group btn-group-block">
            ...
            <a className="btn pt-2" rel="noopener noreferrer" href="https://portal.utilitydistrict.com/3529" target="_blank">
      ...
      <div className="container grid-xs hide-xs">
        ...
        <header className="navbar">
          ...
          <section className="navbar-section">
            ...
            <a className="btn btn-link" rel="noopener noreferrer" href="https://portal.utilitydistrict.com/3529" target="_blank">
